					...
					<div class="container">
						...
						<div>
							<sf:form method="post"
								...
								modelAttribute="user">
								<c:set var="total_wideSquat_time"
									value='${user.day_time + 60.0 }' />
								<c:set var="total_wideSquat_cal"
									value='${user.day_cal + 7.0 }' />
								<sf:input id="day_time" value="${total_wideSquat_time }" path="day_time"
									style="display:none;" />
								<sf:input id="day_cal" value="${total_wideSquat_cal }" path="day_cal"
									style="display:none;" />
