...
<body class="bg-primary">
				...
				<table>
					<tr>
						<td style="width: 20%;"><img class="choice-img-fluid"
							src="resources/images/gif/step.gif" alt="..." /></td>
					...
					<div class="container">
						...
						<div>
							<sf:form method="post"
								...
								modelAttribute="user">
								<c:set var="total_setUp_time"
									value='${user.day_time + 60.0 }' />
								<c:set var="total_setUP_cal"
									value='${user.day_cal + 7.0 }' />
								<sf:input id="day_time" value="${total_setUp_time }" path="day_time"
									style="display:none;" />
								<sf:input id="day_cal" value="${total_setUp_cal }" path="day_cal"
									style="display:none;" />
	...
	<script type="text/javascript">
        ...
        const URL = "resources/model/setUp";
