...
<title>HealthU:: Standing Pulldown</title>
<style>
.modal-header .close2 {
	padding: 1rem 1rem;
...
<body class="bg-primary">
					...
					<div class="container">
						...
						<div>
							<sf:form method="post"
								...
								modelAttribute="user">
								<c:set var="total_standingPulldown_time"
									value='${user.day_time + 60.0 }' />
								<c:set var="total_standingPulldown.jsp_cal"
									value='${user.day_cal + 7.0 }' />
								<sf:input id="day_time" value="${total_standingPulldown.jsp_time }" path="day_time"
									style="display:none;" />
								<sf:input id="day_cal" value="${total_standingPulldown.jsp_cal }" path="day_cal"
									style="display:none;" />
	...
	<script type="text/javascript">
        ...
        const URL = "resources/model/standingPulldown";
