...
<title>HealthU:: Side LateralRaise</title>
<style>
.modal-header .close2 {
	padding: 1rem 1rem;
...
<body class="bg-primary">
				...
				<table>
					<tr>
						<td style="width: 20%;"><img class="choice-img-fluid"
							src="resources/images/gif/sideLateralRaise.gif" alt="..." /></td>
					...
					<div class="container">
						...
						<div>
							<sf:form method="post"
								...
								modelAttribute="user">
								<c:set var="total_sideLateralRaise_time"
									value='${user.day_time + 60.0 }' />
								<c:set var="total_sideLateralRaise_cal"
									value='${user.day_cal + 7.0 }' />
								<sf:input id="day_time" value="${total_sideLateralRaise_time }" path="day_time"
									style="display:none;" />
								<sf:input id="day_cal" value="${total_sideLateralRaise_cal }" path="day_cal"
									style="display:none;" />
	...
	<script type="text/javascript">
        ...
        const URL = "resources/model/sideLateralRaise";
        ...
        async function predict() {
            ...
            if (prediction[0].probability.toFixed(2) > 0.90) {
                ...
                status = "sideLateralRaise";  
                
                msg = "AGAIN";
                  $('#message').css("color","white");
                $('#message').html(msg);
            } else if (prediction[2].probability.toFixed(2) == 1.00) {
                if (status == "sideLateralRaise" || status == "stand") {
