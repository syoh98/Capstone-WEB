...
<title>HealthU:: Chair Squat</title>
<style>
.modal-header .close2 {
	padding: 1rem 1rem;
...
<body class="bg-primary">
				...
				<table>
					<tr>
						<td style="width: 20%;"><img class="choice-img-fluid"
							src="resources/images/gif/chairSquat.gif" alt="..." /></td>
					...
					<div class="container">
						...
						<div>
							<sf:form method="post"
								...
								modelAttribute="user">
								<c:set var="total_chairSquat_time"
									value='${user.day_time + 60.0 }' />
								<c:set var="total_chairSquat_cal"
									value='${user.day_cal + 7.0 }' />
								<sf:input id="day_time" value="${total_chairSquat_time }" path="day_time"
									style="display:none;" />
								<sf:input id="day_cal" value="${total_chairSquat_cal }" path="day_cal"
									style="display:none;" />
	...
	<script type="text/javascript">
        ...
        const URL = "resources/model/chairSquat";
        ...
        async function predict() {
            ...
            if (prediction[0].probability.toFixed(2) > 0.90) {
                ...
                if (status == "chairSquat" || status == "stand") {
